...
function Comment() {
  return (
    <div className="flex items-end gap-1">
      <div className="flex w-fit items-center gap-3 rounded-full bg-py-white/50 px-3">
        <Image
        ...
        <div className="flex flex-col items-start">
          ...
          <p className="text-left text-xs text-py-orange">
            Her voice is so pure...
          </p>
        </div>
      </div>
      <p className="text-[10px] text-py-orange">12:00</p>
    </div>
  );
}
